# RPG OS v9.0.0 — source access and evidence audits
...
Compatible v0.7.3, v0.8.0, v0.8.1 and v8.1.1 campaigns retain their record formats. Use the [protected upgrade guide](ADMIN/UPGRADE_V08.md) in a separate copy. Installing this release does not enable automatic audits, change the agreement or regenerate NPC state.
...
The requested “9.0” is published as v9.0.0, following v8.1.1. This remains an experimental release; its version number is not a claim of stable 1.0 readiness.
