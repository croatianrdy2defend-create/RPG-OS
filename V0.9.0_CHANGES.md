...
Compatible v0.7.3, v0.8.0, v0.8.1 and v0.8.2 campaigns retain their record formats. Use the [protected upgrade guide](ADMIN/UPGRADE_V08.md) in a separate copy. Installing this release does not enable automatic audits, change the agreement or regenerate NPC state.

## Use it

[Quick start](QUICKSTART.md) · [How it works, with diagrams](MECHANICS.md#exact-retrieval-and-evidence-audits) · [Source tools](ADMIN/SOURCE_ACCESS.md) · [Evidence audit](ADMIN/EVIDENCE_AUDIT.md) · [Verification](VERIFICATION.md)
