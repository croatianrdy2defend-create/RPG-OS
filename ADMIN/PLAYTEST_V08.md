...
For the v8.1.1 individual-baseline change, an optional note can capture the exact direct-attention declaration or NPC-initiated approach, the first response, and any available evidence that a tiny current baseline preceded it. "I approach her" does not declare company or flirting. Notice reuse of known people, proportionate treatment of clerks and strangers, and continuity after a requested save. Do not expose hidden facts or request private model reasoning to substantiate a note; missing ordering evidence stays unverified. The optional [B16 diagnostic in TESTS](TESTS.md#b16--individual-baseline-before-a-direct-response) contains six NOT RUN cases, not an extra campaign routine or a behavioral result.
