# RPG OS v0.7.2 targeted reference
...
| Need | Route |
|---|---|
| Present scene, unresolved declaration, due matter | CURRENT_SAVE and accepted post-save play; follow relevant record or active-process pointer |
| Character value or equipment | Save's `pc_record`, then its declared section or subordinate record |
